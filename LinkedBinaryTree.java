...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T> {
	...
	public T getDataRoot() throws EmptyCollectionException {
		...
		if (isEmpty())throw new EmptyCollectionException("EmptyCollectionException");
		return root.getData();
	 ...
	 */
	public boolean contains (BinaryTreeNode<T> r, T targetElement) throws ElementNotFoundException {
		//left as programming project 
		if (r == null) return false; 
		if (r.getData().equals(targetElement)) return true;
